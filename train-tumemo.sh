...
tran_num_layers=3
image_num_layers=6
queue_size=3584            #single is 3584-32-1 multiple is 13568-32-1 hfm is 19968-32-acgrad4 80384 tum
torchrun --nproc_per_node=4 main.py -cuda -gpu_num 0,1,2,3 -epoch ${epoch} -num_workers 0 \
