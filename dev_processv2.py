...
def dev_process(opt, critertion, cl_model, dev_loader, test_loader=None, last_F1=None, last_Accuracy=None, train_log=None, log_summary_writer:SummaryWriter=None):
    ...
    with torch.no_grad():
        ...
        for index, data in enumerate(dev_loader_tqdm):
            ...
            texts_augment, bert_attention_mask_augment, image_augment, text_image_mask_augment, _,_,_,_ = data
            # continue
            ...
            origin_res = cl_model(orgin_param,clip_to_id=None,clip_att_mask=None,clip_image=None)
            ...
            predicted=concat_all_gather(predicted)
