...
queue_size=13568            #single is 3584-32-1 multiple is 13568-32-1 hfm is 19968-32-acgrad4
torchrun --nproc_per_node=4 main.py -cuda -gpu_num 0,1,2,3 -epoch ${epoch} -num_workers 8 \
        ...
        -batch_size ${batch} -queue_size ${queue_size} -acc_grad ${acc_grad} -fuse_type ${fuse_type} -image_output_type ${image_output_type}\
